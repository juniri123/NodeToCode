...
const FText FN2CToolbarCommand::CommandTooltip_SaveParsedJson = NSLOCTEXT("NodeToCode", "SaveParsedJsonTooltip", "Save parsed.json under the translation output directory and open the folder");
const FText FN2CToolbarCommand::CommandTooltip_SaveFlowJson = NSLOCTEXT("NodeToCode", "SaveFlowJsonTooltip", "Save flow.json under the translation output directory and open the folder");
const FText FN2CToolbarCommand::CommandTooltip_SaveFlowText = NSLOCTEXT("NodeToCode", "SaveFlowTextTooltip", "Save flow.txt under the translation output directory and open the folder");
...
void FN2CToolbarCommand::RegisterCommands()
{
    ...
    UI_COMMAND(
        ...
        "Save Parsed Json",
        "Save parsed.json for the current Blueprint graph and open the folder",
        EUserInterfaceActionType::Button,
        FInputChord()
    );
    ...
    UI_COMMAND(
        SaveFlowJsonCommand,
        "Save Flow Json",
        "Save flow.json for the current Blueprint graph and open the folder",
        EUserInterfaceActionType::Button,
        FInputChord()
    );
    ...
    UI_COMMAND(
        SaveFlowTextCommand,
        "Save Flow Text",
        "Save flow text for the current Blueprint graph and open the folder",
        EUserInterfaceActionType::Button,
        FInputChord()
    );
